...
import { BarChart2, Lock, Mail, ArrowRight } from "lucide-react";
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <Card className="bg-white/85 backdrop-blur-2xl border border-white/40">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="relative group">
              <Input
                ...
                required
              />
              <Mail className="absolute right-4 top-[38px] w-5 h-5 text-on-surface/30 group-focus-within:text-primary transition-colors" />
            </div>
            ...
            <div className="relative group">
              <div className="flex items-center justify-between mb-1">
                ...
                <button type="button" className="text-xs font-semibold text-primary hover:brightness-125 transition-all">
                  Forgot password?
                </button>
              </div>
              <Input
          ...
          <div className="mt-8 pt-8 border-t border-on-surface/5">
            <Button variant="secondary" className="w-full grayscale opacity-70 cursor-not-allowed">
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-on-surface/60">
            ...
            <button className="font-bold text-primary hover:underline ml-1">Request Access</button>
          </p>
        </div>
      </div>
    </main>
