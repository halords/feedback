    ...
    <Modal isOpen={isOpen} onClose={onClose} title={isActionNeeded ? "Management Assignment" : "Feedback Analysis"}>
      <div className="space-y-8 p-2">
        ...
        <div className="space-y-3">
          ...
          <div className="p-8 bg-on-surface/[0.02] border border-on-surface/5 rounded-[2.5rem] italic text-xl font-medium text-on-surface/80 leading-relaxed shadow-inner">&ldquo;{comment.commentText}&rdquo;</div>
        </div>
        {isActionNeeded && (
